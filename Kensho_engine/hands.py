...
from Kensho_engine.connectors import jira_connector, asana_connector, confluence_connector, trello_connector, slack_connector
...
def main():
    ...
    try:
        ...
        parser.add_argument('--target', type=str, required=True, choices=['jira', 'asana', 'confluence', 'trello', 'slack'], help='Target platform.')
        parser.add_argument('--config', type=str, default='config.ini', help='Path to the configuration file.')
        args = parser.parse_args()

        logger.info(f"Starting Kensho Hands orchestrator")
